...
// Create a mock peer object for consistent testing
const mockPeer = {
  uuid: 'test-device-id',
  name: 'Test Device',
  role: 'Developer',
...
// Mock BleService with direct callback for testing efficiency
// This follows BeaconAI ruleset: "Mock BLE: Use mock implementations for testing"
  ...
  return {
    default: {
      ...
      startScanning: jest.fn().mockImplementation((onDiscovery) => {
        // Immediately call the callback with mock data (no setTimeout)
